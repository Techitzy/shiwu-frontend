          ...
          {restrictionsExpanded && (
            <View style={styles.restrictionContent}>
              <View style={styles.row}>
                ...
                <View style={styles.counterContainer}>
                  ...
                  <TextInput
                    style={[
                      styles.counterInput,
                      { borderColor: defaultBorderColor, color: textColor },
                    ]}
              ...
              <View style={styles.row}>
                ...
                <View style={styles.counterContainer}>
                  <TouchableOpacity onPress={decrementValue(setMinAge)}>
                    <Ionicons
                      name="remove-circle-outline"
                      size={20}
                      color={primaryColor.main}
                  ...
                  <TextInput
                    ...
                    keyboardType="numeric"
                  />
                  <TouchableOpacity onPress={incrementValue(setMinAge)}>
                    <Ionicons
                      name="add-circle-outline"
                      size={20}
                      color={primaryColor.main}
