...
const DiscardChangesModal = ({
  ...
  const theme = useColorScheme(); // Use color scheme hook to determine theme
      ...
      <View style={styles.modalContainer}>
        <View
          ...
          <Text
            ...
            If you go back now, you'll lose all the changes you've made.
          </Text>
          <TouchableOpacity
            onPress={onDiscard}
          ...
          />
          <TouchableOpacity
            onPress={onKeepEditing} // Assuming onClose is used to keep editing
            style={[styles.button, styles.fullWidthButton]}
            activeOpacity={0.7}>
